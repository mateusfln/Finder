            ...
            <nav class="navbar navbar-toggleable-md navbar-expand-lg navbar-light py-lg-0 py-4">
                ...
                <div id="dl-menu" class="dl-menuwrapper d-block d-lg-none float-right">
                    ...
                    <ul class="dl-menu">
                        ...
                        <li class="nav-item active dropdown">
                            <a class="nav-link" href="#bookmarks" data-toggle="dropdown" aria-expanded="false">Home</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#bookmarks" data-toggle="dropdown" aria-expanded="false">Tags</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#bookmarks" data-toggle="dropdown" aria-expanded="false">Bookmarks</a>
                        </li>
                ...
                <div class="collapse navbar-collapse d-none d-lg-block" id="navbarNav">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="#bookmarks" aria-expanded="false">Home</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#tags" data-toggle="dropdown" aria-expanded="false">Tags</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#bookmarks" data-toggle="dropdown" aria-expanded="false">Bookmarks</a>
                        </li>
