<div id="header-fix" class="header fixed-top transperant">
            <nav class="navbar navbar-toggleable-md navbar-expand-lg navbar-light py-lg-0 py-4">
                <a class="navbar-brand mr-4 mr-md-5" href="index.html"><img src="/images/finder.png" alt="" width="100px"></a> 
                <!-- Mobile Menu -->
                ...
                <div class="collapse navbar-collapse d-none d-lg-block" id="navbarNav">
                    ...
                    <a href="/bookmarks/add" class="btn btn-outline-light btn-sm ml-0 ml-lg-4 mt-3 mt-lg-0"><i class="fa fa-plus pr-1"></i> Add Bookmark</a>
                </div>
                <!-- END Desktop Menu -->
            </nav>                    
        </div>
